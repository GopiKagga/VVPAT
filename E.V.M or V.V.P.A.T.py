...
def win3():
    ...
    btn8 = tk.Button(frame5, text="J,S.P", width=20, relief=RAISED, borderwidth=5, bg="#00FF00", command=rld)
    btn8.config(font=('Arial bold', 17))
    btn8.grid(row=1, column=0, padx=12, pady=2)
    btn9 = tk.Button(frame5, text="T.D.P", width=20, relief=RAISED, borderwidth=5, bg="white", command=aap)
    btn9.config(font=('Arial bold', 17))
    btn9.grid(row=2, column=0, padx=12, pady=2)
    btn10 = tk.Button(frame5, text="Y.C.P", width=20, relief=RAISED, borderwidth=5, bg="blue", command=bsp)
